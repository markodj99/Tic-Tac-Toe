...
const runManualMigrations = async () => {
    try {
      ...
      console.error('Migration of user table resulted in an error:', error);
    }
    ...
    try {
      ...
      console.error('Migration of singleplayerTTT table resulted in an error:', error);
    }
    ...
    try {
      ...
      console.error('Migration of multiplayerTTT table resulted in an error:', error);
    }
};
